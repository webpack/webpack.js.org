...
It is [incredibly configurable](/documentation/configuration), but to get started you only need to understand **Four Core Concepts**: entry, output, loaders, and plugins.
