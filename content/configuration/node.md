...
This is an object where each property is the name of a NodeJS global or module and each value may be one of the following...
...
W> Not every NodeJS global supports all four options. The compiler will throw an error for property-value combinations that aren't supported (e.g. `process: 'empty'`). See the sections below for more details.
