...
T> When using the [`ExtractTextWebpackPlugin`](/documentation/plugins/extract-text-webpack-plugin), use `[contenthash]` to obtain a hash of the extracted file (neither `[hash]` nor `[chunkhash]` work).
