  ...
  module:
    {
        ...
        [
            {
                // Our *.js inputs/sources
                test: /\.jsx?$/,
                // We assure that it won't read the node_modules files
                exclude: /node_modules/,
                // we define our loader/module
                loader: 'babel',
                query: {
                    // we define the preset to be transpiled by babel
                    presets: ['es2015']
                }
