...
Task runners handle automation of common development tasks such as linting, building, or testing your project. Compared to *bundlers* like webpack, Browserify, or Brunch, task runners have a higher level focus. Bundlers, on the other hand, have a much more specific goal.

## What Are Bundlers?

Bundlers take assets, such as JavaScript files and modules, and transform them into a format that's suitable for the browser of the end-user to consume. As your project grows, this task becomes more complex. Maybe you want to split your code into multiple chunks that can be used on-demand. You want to minify your JavaScript and CSS when you deploy your application. You want your application to leverage caching well.

Simply put, bundling is one of the most important challenges in web development, and solving it well can remove a lot of pain from the process.
