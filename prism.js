  ...
  function transformer(tree, file) {
    ...
    function visitor(node) {
      ...
      try {
        ...
        // console.log(JSON.stringify(data.hChildren, null, 2));
      } catch (e) {
        throw e;
      }
      ...
      //     return tree.map((_, i) => {
      //       return newTree.children.indexOf(tree[i])
      //     })
      //   }

      //   const detailsStartIndexes = getIndexes(detailsStart)
      //   const summaryStartIndexes = getIndexes(summaryStart)
      //   const summaryEndIndexes = getIndexes(summaryEnd)
      //   const detailsEndIndexes = getIndexes(detailsEnd)

      //   // console.log(inspect(code))
      //   console.log({ detailsStartIndexes, summaryStartIndexes, summaryEndIndexes, detailsEndIndexes })
