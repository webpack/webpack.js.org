      ...
      request(url, function(err, response, body) {
        ...
        if (body && file === 'README.md') {
          body = body
            ...
            .replace(/https?:\/\/github.com\/(webpack|webpack-contrib)\/([-A-za-z0-9]+-loader)/g, './loaders/$2/') // modify loader links
            .replace(/https?:\/\/github.com\/(webpack|webpack-contrib)\/([-A-za-z0-9]+-plugin)/g, './plugins/$2/') // modify plugin links
