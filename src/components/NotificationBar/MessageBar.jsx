  ...
  return (
    <>
      {listTransitions((styles) => (
        <animated.div
          className="flex items-center rounded z-50 fixed start-px end-px bottom-px bg-white border-2 border-solid border-gray-700 max-w-full ps-20 py-20 shadow-2xl md:start-20 md:end-auto md:bottom-20 md:max-w-[300px] dark:bg-gray-500 print:hidden"
          style={styles}
        >
          <Content />
