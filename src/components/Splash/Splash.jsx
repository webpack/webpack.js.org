...
Splash.keywords = ['webpack', 'webpack 中文文档', '印记中文', 'docschina', 'docschina.org', 'webpack.docschina.org, doc.react-china.org, nodejs.cn, vuefe.cn, babeljs.cn, parceljs.io, rollupjs.cn, koajs.cn'].join(', ');
