...
export default function SplashViz() {
  return (
    ...
    >
      <h1
        dir="rtl"
        className="flex flex-wrap items-center justify-center gap-x-3 text-white text-[33.178px] md:text-[39.813px] text-center font-[200] mt-[80px] md:mt-[90px] row-start-1 row-end-2"
      >
        <span>حزّم</span>
