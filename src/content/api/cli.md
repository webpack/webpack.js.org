...
| `--config`      | string[]        | Provide path to a webpack configuration file e.g. `./webpack.config.js`                                        |
...
| `--merge`       | boolean         | Merge two or more configurations using webpack-merge e.g. `-c ./webpack.config.js -c ./webpack.test.config.js` |
...
| `--output-path` | string          | Output location of the file generated by webpack e.g. `./dist`                                                 |
| `--target`      | string          | Sets the build target                                                                                          |
| `--watch`       | boolean         | Watch for file changes                                                                                         |
| `--hot`         | boolean         | Enables Hot Module Replacement                                                                                 |
| `--no-hot`      | boolean         | Disables Hot Module Replacement                                                                                |
| `--devtool`     | string          | Controls if and how source maps are generated.                                                                 |
| `--prefetch`    | string          | Prefetch this request                                                                                          |
| `--json`        | boolean, string | Prints result as JSON or store it in a file                                                                    |
| `--mode`        | string          | Defines the mode to pass to webpack                                                                            |
| `--version`     | boolean         | Get current version                                                                                            |
