...
Note that accessing `import.meta` directly is not supported by webpack, you need to use `import.meta` as a property access or through the destructuring assignment. E.g.,
