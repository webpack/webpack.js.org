...
```json
{
  ...
  "warningsCount": 0 // number of warnings
}
```
...
```json
{
  ...
  "request": "./lib/index.web.js" // The request that created the chunk group
}
```
...
```json
{
  ...
  "built": true, // Indicates that the module was built ([Loaders](/concepts/loaders) and Parsing) in this compilation
  "cacheable": true, // Whether or not this module is cacheable
  "chunks": [
    // IDs of chunks that contain this module
  ],
  "codeGenerated": true, // Indicates that the module went through Code Generation in this compilation
