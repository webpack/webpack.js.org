...
- [**التحقق من صحة الإضافات باستخدام `compiler.hooks.validate`**](#التحقق-من-صحة-الإضافات-باستخدام-compilerhooksvalidate)
- [**CSS Modules مع حقن النمط في وقت التشغيل**](#css-modules-مع-حقن-النمط-في-وقت-التشغيل)
- [**Tree Shaking أفضل لتفكيك CommonJS**](#tree-shaking-أفضل-لتفكيك-commonjs)
- [**استيرادات مرحلة المصدر لـ WebAssembly (تجريبي)**](#استيرادات-مرحلة-المصدر-لـ-webassembly-تجريبي)
- [**البدء مع `create-webpack-app`**](#البدء-مع-create-webpack-app)
- [**دعم السياق لـ VirtualUrlPlugin**](#دعم-السياق-لـ-virtualurlplugin)
- [**تحليل JavaScript تجريبي باستخدام `oxc-parser`**](#تحليل-javascript-تجريبي-باستخدام-oxc-parser)
- [**تحديثات النظام البيئي**](#تحديثات-النظام-البيئي)
- [**إصلاحات الأخطاء**](#إصلاحات-الأخطاء)
