...
The `ProgressPlugin` is used to customize how progress should be reported during compilation. To generate an HTML file that loads `my-first-webpack.bundle.js`, set [`output.html`](/configuration/output/#outputhtml) — see [Native HTML](/guides/native-html/).
