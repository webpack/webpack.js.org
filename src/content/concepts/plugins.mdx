...
The [build lifecycle](/concepts/under-the-hood/#the-build-lifecycle) shows which phase each hook belongs to. Hooks belong to the object that owns them, and the two reference pages list them in the order they run:
