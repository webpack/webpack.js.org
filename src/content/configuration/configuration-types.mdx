...
Webpack will run the function exported by the configuration file and wait for a Promise to be returned; Or export a promise directly, Webpack will wait for that also. Handy when you need to asynchronously load configuration variables.
