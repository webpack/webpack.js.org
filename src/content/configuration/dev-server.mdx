...
When the server is started, there will be a message before the list of resolved modules:
...
Bypassing an object this behavior can be controlled further using options like `rewrites`:
...
Provides the ability to execute custom middleware before all other middleware
