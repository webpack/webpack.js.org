...
W> Don't specify `https.ca` and `https.cacert` option together, if specified `https.ca` will be used. `https.cacert` is deprecated and will be removed in next major release.
