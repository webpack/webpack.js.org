...
module.exports = {
  ...
  devServer: {
    setupMiddlewares: (middlewares, devServer) => {
      ...
      // Use `unshift` method if you want to run a middleware before others
      // or when you are migrating from `onBeforeSetupMiddleware` option
      middlewares.unshift({
        name: 'fist-in-array',
        // `path` is optional
        path: '/foo/path',
      ...
      // Use `push` method if you want to run a middleware after others
