...
W> webpack-dev-server v4.0.0+ requires <Badge text="node >= v12.13.0" />, <Badge text="webpack >= v4.37.0" /> (but we recommend using <Badge text="webpack >= v5.0.0" />), and <Badge text="webpack-cli >= v4.7.0" />.
