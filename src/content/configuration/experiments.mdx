...
W> **هذه الميزة تجريبية وجزئية.** في webpack 5.107 تم تنفيذ جانب `html-loader` فقط: عند استيراد ملف HTML من JS، تمر مراجع الوسوم عبر pipeline الخاصة بـ webpack. أما **HTML entry points**، أي استخدام ملف `.html` مباشرة كـ `entry`، وهو الجزء المرتبط بـ `html-webpack-plugin`، فهي **غير مدعومة بعد** ومخطط لها في الإصدار minor التالي. يمكن متابعة التفاصيل الكاملة في issue [#536](https://github.com/webpack/webpack/issues/536).
