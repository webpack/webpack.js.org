...
- [`executeModule`](#experimentsexecutemodule): Enable execution of modules from the module graph for plugins and loaders at build time.
...
- [`lazyCompilation`](#experimentslazycompilation): Compile entrypoints and dynamic `import`s only when they are in use.
