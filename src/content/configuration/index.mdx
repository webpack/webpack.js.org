...
module.exports = {
  ...
  stats: {
    ...
    <advancedOptimization "/configuration/stats/">
      <default>
...
Use [webpack-cli's `init` command](https://github.com/webpack/webpack-cli/tree/master/packages/init#cli-via-webpack-cli) to rapidly generate webpack configuration file for your project requirements, it will ask you a couple of questions before creating a configuration file.
