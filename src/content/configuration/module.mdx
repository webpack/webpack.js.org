...
When a function given, returning `true` tells webpack to inject the module into the bundle as Base64-encoded string, otherwise module file will be emitted into output directory.
