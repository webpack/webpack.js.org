...
It's possible to configure all generators' options in one place with `module.generator` <Badge text='5.12.0' />.
...
Similar to [`module.generator`](#modulegenerator), you can configure all parsers' options in one place with `module.parser` <Badge text='5.12.0' />.
