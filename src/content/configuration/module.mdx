  ...
  module: {
    generator: {
      ...
      "css/auto": {
        ...
        // Since webpack 5.108.0, [hash] here resolves to the local ident hash rather than the module hash; use [modulehash] for that. An inline digest/length form is also supported, e.g. [hash:base64:8].
