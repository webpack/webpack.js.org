...
However, parser plugins may accept more than a boolean. For example, the internal `NodeStuffPlugin` can accept an object instead of `true` to add additional options for a particular Rule.
    ...
    rules: [
      {
        ...
        parser: {
          ...
          browserify: false, // disable particular handling of Browserify bundles
