...
By default `optimization.usedExports` is enabled in all [mode](/configuration/mode/).
...
By default `optimization.sideEffects` is enabled in all [mode](/configuration/mode/).
...
By default `optimization.innerGraph` is enabled in all [mode](/configuration/mode/).
