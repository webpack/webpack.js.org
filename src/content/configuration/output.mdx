...
T> Since `webpack v5.54.0+`, `hashFunction` supports `xxhash64` as a fast algorithm. It will be used as default when [`experiments.futureDefaults`](/configuration/experiments/#experimentsfuturedefaults) is enabled.
