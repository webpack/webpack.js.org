...
Set a public path for Worker, defaults to value of [output.publicPath](#outputpublicpath). Avoid this option unless your worker scripts are located at a different path from your other script files.
