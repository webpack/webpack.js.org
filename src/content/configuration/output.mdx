...
T> The default value of this option is depending on the [`target`](/configuration/target/) and [`output.module`](#outputmodule) setting. For more details, search for `"chunkFormat"`: [in the webpack defaults](https://github.com/webpack/webpack/blob/master/lib/config/defaults.js).
...
T> The default value of this option is depending on the [`target`](/configuration/target/) setting. For more details, search for `"chunkLoading"`: [in the webpack defaults](https://github.com/webpack/webpack/blob/master/lib/config/defaults.js).
