...
A list of directories where requests of server-relative URLs (starting with '/') are resolved, defaults to `[options.context]`. On non-windows systems these requests are resolved as absolute path first.
