...
Webpack 5 no longer polyfills Node.js core modules automatically which means you have to install them from npm and include them yourself. Here is a list of polyfills webpack has used before webpack 5:
