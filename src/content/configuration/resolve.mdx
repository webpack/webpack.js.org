...
Webpack 5 no longer polyfills Node.js core modules automatically which means you have to install compatible modules from npm and include them yourself if you're bundling code for browser. Here is a list of polyfills webpack has used before webpack 5:
