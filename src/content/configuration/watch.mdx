...
通过传递 `true` 开启 [polling](<https://en.wikipedia.org/wiki/Polling_(computer_science)>)，将会设置默认轮询间隔为 [`5007`](https://github.com/webpack/watchpack/blob/a54bcdb95759558ca5a9fc2819c4d71b771c162f/lib/DirectoryWatcher.js#L79)，或者指定毫秒为单位进行轮询。
