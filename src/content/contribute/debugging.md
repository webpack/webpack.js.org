...
This gives you the ability to create breakpoints, debug memory usage, expose and examine objects in the console, and much more without much complexity. In this short demo, we'll utilize the [`node-nightly`](https://github.com/hemanth/node-nightly) package which provides access to the latest and greatest inspecting capabilities.
