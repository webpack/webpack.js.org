...
If Pull Request author grants write access to his fork to the [webpack Documentation team](https://github.com/orgs/webpack/teams/documentation-team/members) we will commit directly to your branch and finish the work. In other case, we may have to start over by ourselves or by delegating it to willing community members. This may render your Pull Request redundant and it might get closed as a part of clean up process.
