...
W> The [`schema-utils`](https://github.com/webpack/schema-utils) API has changed in recent versions. Webpack still uses the v1.0.0 release, and we ask you to do the same until further notice.
