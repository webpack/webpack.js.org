...
**** Webpack errors causes 

The webpack maybe wrong install .If you beleive right install , you review creating files such as dist, js and src. You need make those file under name dist, js and src.
