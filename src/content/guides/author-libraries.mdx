...
```
If your library directly imports a package like `lodash`, it should be listed under `dependencies` rather than `devDependencies` or `peerDependencies`, since it is required at runtime.
