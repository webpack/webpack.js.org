...
The first and last are expected, it's the `vendor` hash we want to fix. Lets use [`optimization.moduleIds`](/configuration/optimization/#optimizationmoduleids) with `'hashed'` option:
