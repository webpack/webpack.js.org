...
Let's get our project set up using the example from [getting started](/guides/getting-started), letting webpack write the page for us as in [output management](/guides/output-management), so we don't have to deal with maintaining our `index.html` file manually:
...
[`output.html`](/configuration/output/#outputhtml) writes a document around the entry and injects its chunks, so the page tracks the hashed filenames on every build.

T> Webpack builds the page it generated, which means your entry's code is bundled as a chunk of that page and carries a generated chunk name such as `__html_c191ce97_0`. The name is stable across builds — only the `[contenthash]` in the filename moves — and it is what the listings below show in place of `main`.
...
__html_c191ce97_0.7e2c49a622975ebd9b7e.js     544 kB       0  [emitted]  [big]  __html_c191ce97_0
...
...
                       Asset       Size  Chunks                    Chunk Names
__html_c191ce97_0.205199ab45963f6a62ec.js     544 kB       0  [emitted]  [big]  __html_c191ce97_0
                  index.html  197 bytes          [emitted]
...
```
...
runtime.cc17ae2a94ec771e9221.js   1.42 KiB       0  [emitted]  runtime
   __html_c191ce97_0.e81de2cf758ada72f306.js   69.5 KiB       1  [emitted]  __html_c191ce97_0
...
vendors.a42c3ca0d742766d7a28.js   69.4 KiB       1  [emitted]  vendors
   __html_c191ce97_0.abf44fedb7d11d4312d7.js  240 bytes       2  [emitted]  __html_c191ce97_0
                     index.html  353 bytes          [emitted]
...
```

We can now see that our application bundle does not contain `vendor` code from `node_modules` directory and is down in size to `240 bytes`!
...
Running another build, we would expect only our application bundle's hash to change, however...
...
...
  ...
  vendor.a7561fb0e9a071baadb9.js     541 kB       1  [emitted]  [big]  vendor
    __html_c191ce97_0.b746e3eb72875af2caa9.js    1.22 kB       2  [emitted]         __html_c191ce97_0
...
- The application bundle changed because of its new content.
...
...
                          Asset       Size  Chunks             Chunk Names
   __html_c191ce97_0.216e852f60c8829c2289.js  340 bytes       0  [emitted]  __html_c191ce97_0
vendors.55e79e5927a639d21a1b.js   69.5 KiB       1  [emitted]  vendors
runtime.725a1a51ede5ae0cfde0.js   1.42 KiB       2  [emitted]  runtime
                     index.html  353 bytes          [emitted]
Entrypoint __html_c191ce97_0 = runtime.725a1a51ede5ae0cfde0.js vendors.55e79e5927a639d21a1b.js __html_c191ce97_0.216e852f60c8829c2289.js
...
```
...
...
                          Asset       Size  Chunks             Chunk Names
   __html_c191ce97_0.ad717f2466ce655fff5c.js  274 bytes       0  [emitted]  __html_c191ce97_0
vendors.55e79e5927a639d21a1b.js   69.5 KiB       1  [emitted]  vendors
runtime.725a1a51ede5ae0cfde0.js   1.42 KiB       2  [emitted]  runtime
                     index.html  353 bytes          [emitted]
Entrypoint __html_c191ce97_0 = runtime.725a1a51ede5ae0cfde0.js vendors.55e79e5927a639d21a1b.js __html_c191ce97_0.ad717f2466ce655fff5c.js
...
```
