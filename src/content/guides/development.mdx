...
Let's start by setting [`mode` to `'development'`](/configuration/mode/#mode-development), and let's retitle the page while we are at it.
...
asset __html_6d047296_1.bundle.js 1.38 MiB [emitted] (name: __html_6d047296_1)
asset __html_6d047296_0.bundle.js 16.1 KiB [emitted] (name: __html_6d047296_0)
asset main.bundle.js 2.05 KiB [emitted] (name: main)
asset index.html 241 bytes [emitted] (auxiliary name: main)
...
cacheable modules 534 KiB (javascript) 207 bytes (html)
  ...
  ./src/index.html 217 bytes (javascript) 207 bytes (html) [built] [code generated]
  ./node_modules/lodash/lodash.js 533 KiB [built] [code generated]
webpack 5.x.x compiled successfully in 344 ms
```
...
...
<i> [webpack-dev-middleware] asset __html_6d047296_1.bundle.js 1.38 MiB [emitted] (name: __html_6d047296_1)
<i> asset __html_6d047296_0.bundle.js 16.1 KiB [emitted] (name: __html_6d047296_0)
<i> asset main.bundle.js 2.05 KiB [emitted] (name: main)
<i> asset index.html 241 bytes [emitted] (auxiliary name: main)
...
<i>   ./src/index.html 217 bytes (javascript) 207 bytes (html) [built] [code generated]
<i>   ./node_modules/lodash/lodash.js 533 KiB [built] [code generated]
<i> webpack 5.x.x compiled successfully in 344 ms
