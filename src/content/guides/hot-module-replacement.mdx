...
- [Live Reload Browser Page](https://github.com/Yuriy-Svetlov/live-reload-bp): If you enable the "Partial reload" option, the plugin will replace the module on the fly, without reloading the entire browser page.
