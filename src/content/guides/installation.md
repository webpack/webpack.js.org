...
T> To run the local installation of webpack you can access its bin version as `node_modules/.bin/webpack`. Alternatively, if you are using npm v5.2.0 or greater, you can use npx by running 'npx webpack'. This will run the locally installed binary of webpack.
