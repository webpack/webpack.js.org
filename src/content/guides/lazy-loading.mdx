...
`import.defer()` now supports context modules (dynamic import paths). This is useful when you need to defer evaluation of modules loaded through dynamic expressions.
