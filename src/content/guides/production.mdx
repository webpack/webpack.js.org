...
Note that while the [`MinimizerPlugin`](/plugins/minimizer-webpack-plugin/) is a great place to start for minification and being used by default, there are other options out there:
