...
<span id="mark-the-file-as-side-effect-free"></span>
...
## وسم تصريح دالة بأنه خالٍ من الآثار الجانبية {#mark-a-function-declaration-as-side-effect-free}
...
T> بدءًا من webpack 5.108.0، ينتقل أثر هذا التعليق عبر حدود الوحدات؛ لذلك يمكن حذف الاستدعاء غير المستخدم حتى لو كان في وحدة تستورد الدالة. قبل هذا الإصدار، كان تأثيره يقتصر على الوحدة التي صُرّحت فيها الدالة.

T> إذا تعذر عليك تعديل المصدر لإضافة التعليق، كأن تكون الدالة واردة من إحدى الاعتماديات، فيمكنك تحديد الأسماء الخالية من الآثار الجانبية من ملف التخصيص باستخدام [`module.parser.javascript.pureFunctions`](/configuration/module/#moduleparserjavascriptpurefunctions)، المتاح منذ webpack 5.108.0.
