...
T> بدءًا من webpack 5.108.0، تنتقل هذه العلامة عبر حدود modules، ولذلك تُحذف أيضًا الاستدعاءات غير المستخدمة داخل module مستورِدة. قبل الإصدار 5.108.0، كان تأثيرها يقتصر على module التي صُرِّح فيها.

T> إذا تعذّر تعديل الشيفرة المصدرية لإضافة العلامة، كما في دالة تأتي من dependency، فيمكنك تحديد الأسماء الخالية من الآثار الجانبية في ملف التخصيص باستخدام [`module.parser.javascript.pureFunctions`](/configuration/module/#moduleparserjavascriptpurefunctions)، المتاح منذ 5.108.0.
