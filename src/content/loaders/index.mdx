...
T> HTML is built in ([`experiments.html`](/configuration/experiments/#experimentshtml), experimental), so `html-loader` is not listed here — it is deprecated, and the [Native HTML](/guides/native-html/) guide covers [what is built in](/guides/native-html/#whats-built-in) and [how to migrate](/guides/native-html/#migrating-from-html-loader). Template engines always keep their loader.
...
T> CSS is built in ([`experiments.css`](/configuration/experiments/#experimentscss), experimental), so no loader is listed here for plain CSS — the [Native CSS](/guides/native-css/) guide covers [what is built in](/guides/native-css/#whats-built-in) and how to move an existing setup over. Preprocessors always keep their loader.
