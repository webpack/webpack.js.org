...
T> HTML is built in ([`experiments.html`](/configuration/experiments/#experimentshtml), experimental), so no loader is listed here for plain HTML — the [Native HTML](/guides/native-html/) guide covers [what is built in](/guides/native-html/#whats-built-in) and how to move an existing setup over. Template engines always keep their loader.
