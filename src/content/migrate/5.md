...
- If you are using Yarn's PnP and the `pnp-resolver-plugin`, we have good news: it is supported by default now, but you have to remove it from the configuration.
