...
Webpack 5 core requires at least Node.js 10.13.0 (LTS), so make sure you upgrade your Node.js if you're still running an older one. Note that webpack-cli v7.0.0+ requires Node.js >= 20.9.0.
