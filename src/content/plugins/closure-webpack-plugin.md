...
## Aggressive Bundle Mode {#aggressive-bundle-mode}
...
In Aggressive Bundle Mode, a file can only appear in a single output chunk. Use the [Split Chunks Plugin](/plugins/split-chunks-plugin/)
...
The [concatenatedModules optimization](/configuration/optimization/#optimizationconcatenatemodules)
...
## Multiple Output Languages {#multiple-output-languages}
...
## Other tips for Use {#other-tips-for-use}
...
# Closure Library Plugin {#closure-library-plugin}
