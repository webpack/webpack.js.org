...
T> It supersedes [`copy-webpack-plugin`](https://github.com/webpack/copy-webpack-plugin), which is deprecated in its favour and remains the answer only for webpack older than 5.111.0.
