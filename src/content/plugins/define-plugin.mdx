...
- <Badge text="5.26.0+" /> The second argument can also take an options object argument
  with the following properties - - `fileDependencies?: string[]` A list of files
  the function depends on. - `contextDependencies?: string[]` A list of directories
  the function depends on. - `missingDependencies?: string[]` A list of not existing
