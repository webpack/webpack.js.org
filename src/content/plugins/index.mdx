...
T> Webpack has experimental built-in CSS and HTML support, so two of the plugins below have a built-in alternative for the common case. What each still covers that webpack does not is stated in [What's built-in](/guides/native-css/#whats-built-in) for CSS and [What's built-in](/guides/native-html/#whats-built-in) for HTML.
...
| [`HtmlWebpackPlugin`](/plugins/html-webpack-plugin)                             | Easily create HTML files to serve your bundles. Built-in alternative: [`output.html`](/configuration/output/#outputhtml)                 |
...
| [`MiniCssExtractPlugin`](/plugins/mini-css-extract-plugin)                      | Creates a CSS file per JS file which requires CSS. Built-in alternative: [`experiments.css`](/configuration/experiments/#experimentscss) |
