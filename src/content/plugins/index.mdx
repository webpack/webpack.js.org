...
| [`MinimizerPlugin`](/plugins/minimizer-webpack-plugin/)                         | Minify the JS/CSS/HTML/JSON/etc in your project, and [compress what it emits](/plugins/minimizer-webpack-plugin/#compressing-with-minifying-and-without)               |
