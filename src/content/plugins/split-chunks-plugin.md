...
This option lets you specify a maximum name length to which the chunk names generated by the SplitChunksPlugin will be truncated. By default, Webpack's chunk names are truncated at 109 characters, which is on the long side and is done to prevent errors.
