...
- `scheme` (`string`): URL scheme for virtual modules, default is `'virtual'`. The second constructor argument is either the scheme string or an object `{ scheme?, context? }`.
